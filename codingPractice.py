...
# ------------------ Calculator# ------------------ #
# operation = input("What type of operation you want to perform? - Addition, Subtraction, Multiplication and Division - ").lower()
# num1 = int(input("Enter a number:- "))
# num2 = int(input("Enter a number:- "))
...
# print("Your name in reversed order is",reversed_name)
...
# fullName = input("Please enter yor full name:- ")
# count = 0
# for i in fullName:
#     if i == " ":
#         continue
...
# print("Merged list is",merged_num)
...
#     if i in list2:
#         common_ele.append(i)
# print("The list with common elements is",common_ele)

# Q.38.Count occurrences of elements

# marks = (12,14,16,12,11)
# marks_occurence = marks.count(12)
# print("The number of students who got marks-12 is",marks_occurence)
...
# def topSquaresGenerator(limit):
#     i = 1
#     while i<=limit:
#         squares = i * i
#         yield squares
#         i += 1
# result = topSquaresGenerator(5)
...
#     print("Number can't be zero",z)
# except ValueError as v:
#     print("Please enter a valid value",v)
...
#         self.company = "HSBC"
#     def tenure(self):
#         return f"{self.name} is working in {self.company} for more than 2 years"
...
#         if nums[i]==ele:
#             return ele,"found at",i
#     else:
#         return -1

# nums = [11,21,34,32,1,2,3,3,4]
